...
public class AnalyzerWrapperTests extends AnalyzerWrapper {
    ...
    public void testGetWeighedChemistryPoints() {
        assertEquals(0.0, AnalyzerWrapper.getWeightedChemistryPoints(0, 0, 0));
        assertEquals(0.5, AnalyzerWrapper.getWeightedChemistryPoints(0, 1, 0));
        assertEquals(1.0, AnalyzerWrapper.getWeightedChemistryPoints(0, 2, 0));
        assertEquals(1.0, AnalyzerWrapper.getWeightedChemistryPoints(0, 0, 1));
        assertEquals(2.0, AnalyzerWrapper.getWeightedChemistryPoints(0, 0, 2));
        assertEquals(100.0, AnalyzerWrapper.getWeightedChemistryPoints(100, 0, 0));
        assertEquals(105.0, AnalyzerWrapper.getWeightedChemistryPoints(100, 1, 0));
        assertEquals(110.0, AnalyzerWrapper.getWeightedChemistryPoints(100, 2, 0));
        assertEquals(110.0, AnalyzerWrapper.getWeightedChemistryPoints(100, 0, 1));
        assertEquals(120.0, AnalyzerWrapper.getWeightedChemistryPoints(100, 0, 2));
        assertEquals(115.0, AnalyzerWrapper.getWeightedChemistryPoints(100, 1, 1));
        assertEquals(120.0, AnalyzerWrapper.getWeightedChemistryPoints(100, 2, 1));
        assertEquals(130.0, AnalyzerWrapper.getWeightedChemistryPoints(100, 2, 2));
        assertEquals(1300.0, AnalyzerWrapper.getWeightedChemistryPoints(1000, 2, 2));
    }
    ...
    public void testGetGoalsChemistry() {
        ...
        goals.add(goal1);
        assertEquals(0, AnalyzerWrapper.getGoalsChemistry(playerId1, playerId2, goals));

        goal1.getPlayerIds().add(playerId1);
        goal1.getPlayerIds().add(playerId2);
        goal1.setOpponentGoal(true);
        assertEquals(-1, AnalyzerWrapper.getGoalsChemistry(playerId1, playerId2, goals));
        goal1.setOpponentGoal(false);
        assertEquals(1, AnalyzerWrapper.getGoalsChemistry(playerId1, playerId2, goals));
        goal1.setScorerId(playerId1);
        assertEquals(2, AnalyzerWrapper.getGoalsChemistry(playerId1, playerId2, goals));
        ...
        goal1.setScorerId(playerId1);
        goal1.setAssistantId(playerId2);
        assertEquals(3, AnalyzerWrapper.getGoalsChemistry(playerId1, playerId2, goals));
        goal1.setScorerId(playerId2);
        goal1.setAssistantId(playerId1);
        assertEquals(3, AnalyzerWrapper.getGoalsChemistry(playerId1, playerId2, goals));
    }
    ...
    public void testGetStrengthsChemistry() {
        ...
        assertEquals(1, AnalyzerWrapper.getStrengthsChemistry(playerPos, player, comparePlayerPos, comparePlayer));
    ...
    public void testGetStrengthsChemistryNull() {
        ...
        Player.Position comparePlayerPos = Player.Position.C;
        Player comparePlayer = new Player();
        assertEquals(0, AnalyzerWrapper.getStrengthsChemistry(playerPos, player, comparePlayerPos, comparePlayer));
    ...
    public void testGetShootsChemistry() {
        ...
        assertEquals(1, AnalyzerWrapper.getShootsChemistry(playerPos, playerShoots, comparePlayerPos, comparePlayerShoots));
        comparePlayerPos = Player.Position.LD;
    ...
    public void testGetShootsChemistryZero() {
        ...
        assertEquals(0, AnalyzerWrapper.getShootsChemistry(playerPos, playerShoots, comparePlayerPos, comparePlayerShoots));
